<footer class="border-t border-emerald-100 bg-theme-light px-4 py-6 sm:px-5 lg:px-6 xl:px-8">
    <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div class="flex items-center gap-3 sm:gap-4">
            <div class="flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center">
                <img src="{{ asset('img/logo.png') }}" alt="Logo TPBIS" class="h-14 w-14 sm:h-18 sm:w-18 object-contain">
            </div>
            <div>
                <p class="text-[11px] sm:text-xs text-slate-600">
                    Kabupaten Probolinggo · Transformasi
                    Perpustakaan Berbasis Digital
                </p>
            </div>
        </div>
        <div class="text-sm leading-6 text-slate-600">
            <p>Data terbuka untuk masyarakat.</p>
            <p>Sumber Data: Perpusnas RI (API TPBIS)</p>
            <p>© 2026 TPBIS Kabupaten Probolinggo</p>
        </div>
