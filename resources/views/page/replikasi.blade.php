    ...
    <div class="w-full min-h-screen">
        ...
        <main class="px-3 py-3 sm:px-4 sm:py-4 lg:px-5 lg:py-5 xl:px-6">
            ...
            <section class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <article class="metric-card rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover-card">
                    <div class="flex items-start justify-between gap-3">
                        <div class="min-w-0">
                            <p class="text-sm text-slate-500">Total Dana</p>
                            <h3 id="stat-dana" class="mt-2 text-2xl lg:text-3xl font-extrabold text-theme-dark">
                                -
                            </h3>
                        </div>
                ...
                <article class="metric-card rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover-card">
                    <div class="flex items-start justify-between gap-3">
                        <div class="min-w-0">
                            ...
                            <h3 id="stat-desa" class="mt-2 text-3xl font-extrabold text-blue-600">
                                -
                            </h3>
                        </div>
                ...
                <article class="metric-card rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover-card">
                    <div class="flex items-start justify-between gap-3">
                        <div class="min-w-0">
                            <p class="text-sm text-slate-500">
                                Total Laporan Replikasi
                            </p>
                            <h3 id="stat-laporan" class="mt-2 text-3xl font-extrabold text-emerald-600">
                                -
                            </h3>
                        </div>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                <h3 class="mb-4 text-base font-bold text-theme-dark">
                    Daftar Replikasi Mandiri
                </h3>
                <div class="overflow-x-auto custom-scrollbar">
                    <table id="tabel-replikasi" class="w-full text-left text-sm text-slate-600 hover">
